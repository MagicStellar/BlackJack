...
const ITEMS = [
  {
    ...
    howTo: "Tap the item any time before the cylinder starts spinning. Instantly reveals if the upcoming check is loaded or empty — visible only to you.",
    tip: "Best used when you might be last place. Knowing the chamber lets you decide whether to arm a Shield.",
    turnCost: 'Usable any time before roulette — does NOT end your turn',
  ...
  },
  {
    ...
    howTo: "Tap the item any time before the cylinder starts spinning. It is consumed immediately and stays armed until it blocks one fatal shot.",
    tip: "Holding it unused does nothing. Peek first if you can, then arm the shield only if you think you will face the gun.",
    turnCost: 'Usable any time before roulette — does NOT end your turn',
  ...
  },
  {
    ...
    howTo: "Tap the item on your turn (before you stand or bust). Your most-recently drawn card is replaced by a fresh card from the shoe.",
    tip: "Use after a bad hit while it's still your turn. You cannot redraw after you stand or bust. You still Hit or Stand after redrawing.",
    turnCost: 'Your turn only — does NOT end your turn',
  ...
  },
  {
    ...
    tip: "Best attack: swap onto someone sitting at 19–20. You cannot swap after you stand, bust, or after cards are revealed.",
    turnCost: 'Your turn only — does NOT end your turn',
  ...
  },
  {
    ...
    howTo: "On your turn, tap the item, then select a target. On their next turn they are forced to draw an extra card before they can decide.",
    tip: "Most powerful against an opponent who has 18–20 and still has to take their turn. You cannot use it after you stand or bust.",
    turnCost: 'Your turn only — does NOT end your turn',
